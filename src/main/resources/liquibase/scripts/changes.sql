ALTER TABLE rule_arguments
DROP CONSTRAINT fk_condition;

ALTER TABLE rule_conditions
DROP CONSTRAINT fk_rule;
...
DROP TABLE dynamic_rules CASCADE;

DROP TABLE notification_task CASCADE;

DROP TABLE rule_arguments CASCADE;

DROP TABLE rule_conditions CASCADE;-- liquibase formatted sql